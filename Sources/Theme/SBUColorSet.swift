...
public class SBUColorSet {
    ...
    public static var navigationBarTint = UIColor.white
    public static var navigationButtonTint = UIColor(white: 0.0, alpha: 1.0)
    public static var navigationTitleColor = UIColor(white: 0.0, alpha: 1.0)
}
